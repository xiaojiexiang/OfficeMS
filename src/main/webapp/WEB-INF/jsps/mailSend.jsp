...
<body>
	...
	<form id="mailSendForm" name="mailSendForm" enctype="multipart/form-data" >
		<div class="main">
						...
						<table width="90%" border="0" cellspacing="10px">
							<tr>
								...
								<td align="left"><select name="receiveId"
								 ...
								 <input type="hidden" name="sendId" value="${sessionUser.id}" />
								 <input type="hidden" name="sendUname" value="${sessionUser.username}" /></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td align="left"><input type="file" name="mailFile"
									id="mailFile" /><span style="color: red;">*</span>(上传附件不能超过9M)</td>
							</tr>
